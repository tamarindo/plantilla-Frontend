...
(function(){
  ...
  btnAgregar = document.getElementById('lsBtnGuardar');
  btnBorrar = document.getElementById('lsBtnBorrar');
  btnLimpiar = document.getElementById('lsBtnLimpiar');

// listener
  btnBorrar.addEventListener('click',removerItem);
  btnLimpiar.addEventListener('click',limpiar);
  btnAgregar.addEventListener('click',guardarItem);
})();